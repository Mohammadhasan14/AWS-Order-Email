import {
  ...
  export default function SmartBulkTable({
    ...
    useEffect(() => {
      const filteredOrders = persistOrders.filter((data) =>
        selectedResources.includes(data.id)
      );
      setSelectedTableData(filteredOrders);
    }, [selectedResources, persistOrders, setSelectedTableData]);
          ...
          return (
            <Fragment key={orderID}>
              ...
              >
                ...
                <IndexTable.Cell>{data?.shippingAddress?.firstName}</IndexTable.Cell>
                <IndexTable.Cell>{data?.shippingAddress?.lastName}</IndexTable.Cell>
                <IndexTable.Cell>
                  {data?.email || data?.customer?.email || "N/A"}
                </IndexTable.Cell>
                <IndexTable.Cell>
                  <Badge tone={data?.dbData?.isEmailSent ? "success" : "attention"}>
